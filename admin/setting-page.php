...
function nobi_connect_settings_init() {
    ...
    add_settings_field(
        ...
        array(
            'name' => 'domain',
            'description' => 'Tên miền đầy đủ hệ thống Nobita của bạn (vd: shopabc.ecrm.vn, shopxyz.nobi.pro)',
    ...
    add_settings_field(
        ...
        array(
            'name' => 'apikey',
            'description' => 'Nhận ApiKey theo hướng dẫn <a href="https://help.nobita.pro/api/key-xac-thuc" target="_blank">tại đây</a> (vd: 15950b1f-864a-4b48-857f-332ba0e021db)',
